...
\begin{figure}[h]
	...
	دید کلی از نتیجه
	\qquad\hspace{3mm}]{
		\label{app_result_FEMNISTwriter_base}
		\includegraphics*[width=.48\textwidth]{images/chap5/result/FEMNISTwriter/loss_base.png}
	}
	\hspace{0.8mm}
	\subfigure[
	بزرگ‌نمایی شده بخش اصلی					
	\qquad\hspace{5mm}]{
		\label{app_result_FEMNISTwriter_zoom}
		\includegraphics*[width=.48\textwidth]{images/chap5/result/FEMNISTwriter/loss_zoom.png}
	}
	\caption{
		مقایسه منحنی‌های خطا بر روی مجموعه داده
		\lr{FEMNISTwriter}.
	}
	\label{app_result_FEMNISTwriter}
\end{figure}
